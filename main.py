...
async def help(ctx):
    ...
    embed.set_footer(text='Bot created by Sidewinder#4682')
    ...
    embed.add_field(name='{0}.cardList/list (set name)'.format(prefix), value='Displays the cards in a specified set or structure/starter deck', inline=False)
